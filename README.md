...
- Fedimint runs `fedimintd` plus `gatewayd lnd`, reusing the configured Bitcoin RPC and the local LND. See the [Fedimint configuration guide](docs/27_FEDIMINT_CONFIGURATION_PT_BR.md).

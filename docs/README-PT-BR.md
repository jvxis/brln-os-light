...
precisa estar no Wi-Fi/Ethernet e disponibilizar a API TCP do Meshtastic.
Dispositivos com MUI podem não suportar TCP; confira a compatibilidade do firmware ou utilize USB.

...
func TestPeerSwapServicesUseDedicatedIdentityAndRemoteSourceIsIndependent(t *testing.T) {
	...
	for _, want := range []string{"User=" + PeerSwapUser, "ProtectSystem=strict", "ProtectHome=true", "NoNewPrivileges=true", "ReadWritePaths=" + paths.RuntimeDir, ElementsService + ".service"} {

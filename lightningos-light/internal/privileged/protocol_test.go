...
func TestDecodeRequestStrictValidation(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "valid Electrs storage", payload: `{"version":1,"request_id":"request_1","operation":"app.catalog.storage.ensure","params":{"app_id":"electrs","data_dir":"/mnt/chain/lightningos/electrs"}}`},
		{name: "valid Mempool storage", payload: `{"version":1,"request_id":"request_1","operation":"app.catalog.storage.ensure","params":{"app_id":"mempool","data_dir":"/mnt/chain/lightningos/mempool"}}`},
		{name: "catalog storage app rejected", payload: `{"version":1,"request_id":"request_1","operation":"app.catalog.storage.ensure","params":{"app_id":"lndg","data_dir":"/mnt/chain/lightningos/lndg"}}`, wantErr: true},
		{name: "catalog storage arbitrary path rejected", payload: `{"version":1,"request_id":"request_1","operation":"app.catalog.storage.ensure","params":{"app_id":"electrs","data_dir":"/etc/shadow"}}`, wantErr: true},
		...
		{name: "valid mdns package ensure", payload: `{"version":1,"request_id":"request_1","operation":"packages.feature.ensure","params":{"feature":"mdns"}}`},
		{name: "valid mdns package ensure dry run", payload: `{"version":1,"request_id":"request_1","operation":"packages.feature.ensure","dry_run":true,"params":{"feature":"mdns"}}`},
		{name: "valid mdns package status", payload: `{"version":1,"request_id":"request_1","operation":"packages.feature.status","params":{"feature":"mdns"}}`},
		...
		{name: "mdns package injection", payload: `{"version":1,"request_id":"request_1","operation":"packages.feature.ensure","params":{"feature":"mdns","packages":["openssh-server"]}}`, wantErr: true},
		{name: "valid manager LAN policy", payload: `{"version":1,"request_id":"request_1","operation":"manager.firewall.configure","params":{"mode":"lan","lan_cidr":"192.168.68.0/24"}}`},
		{name: "valid manager VPN policy dry run", payload: `{"version":1,"request_id":"request_1","operation":"manager.firewall.configure","dry_run":true,"params":{"mode":"vpn"}}`},
		{name: "valid acknowledged unprotected policy", payload: `{"version":1,"request_id":"request_1","operation":"manager.firewall.configure","params":{"mode":"unprotected","acknowledge_unprotected":true}}`},
		{name: "manager LAN policy rejects command input", payload: `{"version":1,"request_id":"request_1","operation":"manager.firewall.configure","params":{"mode":"lan","lan_cidr":"192.168.68.0/24;reboot"}}`, wantErr: true},
		{name: "manager LAN policy rejects IPv6", payload: `{"version":1,"request_id":"request_1","operation":"manager.firewall.configure","params":{"mode":"lan","lan_cidr":"fd00::/64"}}`, wantErr: true},
		{name: "manager unprotected policy requires acknowledgement", payload: `{"version":1,"request_id":"request_1","operation":"manager.firewall.configure","params":{"mode":"unprotected"}}`, wantErr: true},
		...
		{name: "valid image status", payload: `{"version":1,"request_id":"request_1","operation":"app.image.status","params":{"app_id":"cpuminer","variant":"fast_pinned"}}`},
		...
		{name: "valid image probe", payload: `{"version":1,"request_id":"request_1","operation":"app.image.probe","params":{"app_id":"cpuminer","variant":"fast_pinned"}}`},

...
func TestWithinMaxHTLCHysteresis(t *testing.T) {
  tests := []struct {
    ...
    {
      name:        "drained channel uses target relative threshold",
      currentSat:  12876,
      targetSat:   3507,
      effectiveCapacitySat: 24750000,
      volatileBalance: false,
      want:        false,
    },
    {
      name:        "drained channel allows tiny target relative delta",
      currentSat:  3530,
      targetSat:   3507,
      effectiveCapacitySat: 24750000,
      volatileBalance: false,
    ...
    {
      name:        "empty channel does not keep stale max within base threshold",
      currentSat:  251,
      targetSat:   1,
      effectiveCapacitySat: 4950000,
      volatileBalance: false,
      want:        false,
    },
    {

...
var legacyPrivilegeCallBudgets = map[string]privilegeCallBudget{
	...
	"internal/server/apps_peerswap_elements_source.go": {runSystemd: 2},
	"internal/server/apps_publicpool.go":               {runSudo: 5},
	"internal/server/apps_robosats.go":                 {runSudo: 4},
	"internal/server/apps_storage_permissions.go":      {runSystemd: 1},
	"internal/server/apps_tapd.go":                     {runSudo: 1},
...
var legacyPrivilegedShellLiteralBudgets = map[string]int{
	...
	"internal/server/apps_elements.go":    11,
	"internal/server/apps_loop.go":        6,
	"internal/server/apps_peerswap.go":    12,

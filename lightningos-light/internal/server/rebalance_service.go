	...
	for _, channel := range channels {
		...
		desired = append(desired, AutomationIntent{
			...
			Evidence: map[string]any{
				...
				"current_outgoing_base_msat":  channel.OutgoingBaseMsat,
				"outgoing_base_effective_ppm": effectivePolicyPpm(0, channel.OutgoingBaseMsat, channel.EconomicReferenceAmountSat),
				"peer_fee_rate_ppm":           channel.PeerFeeRatePpm,
				"peer_base_msat":              channel.PeerBaseMsat,
				"peer_base_effective_ppm":     effectivePolicyPpm(0, channel.PeerBaseMsat, channel.EconomicReferenceAmountSat),

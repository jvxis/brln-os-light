...
func (s *Server) routes() http.Handler {
  ...
  r.Get("/api/apps/tailscale/auth-url", s.handleTailscaleAuthURL)
  r.Get("/api/apps/tailscale/status", s.handleTailscaleStatus)
  r.Post("/api/apps/tailscale/logout", s.handleTailscaleLogout)

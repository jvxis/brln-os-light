...
func (s *Server) routes() http.Handler {
	...
	r.Get("/api/apps/opreturn/status", s.handleOPReturnStatus)
	r.Post("/api/apps/opreturn/preview", s.handleOPReturnPreview)
	r.Post("/api/apps/opreturn/publish", s.handleOPReturnPublish)
	r.Get("/api/apps/opreturn/records", s.handleOPReturnRecords)
	r.Get("/api/apps/opreturn/records/{id}", s.handleOPReturnRecords)
	...
	r.Post("/api/apps/peerswap/elements-source", s.handlePeerswapElementsSourcePost)
	...
	r.Post("/api/apps/tapd/universe-sync", s.handleTapdUniverseSync)
	...
	r.Get("/api/apps/loop/status", s.handleLoopStatus)
	r.Get("/api/apps/loop/swaps", s.handleLoopSwaps)
	...
	r.Get("/api/apps/loopout-brln/strike/status", s.handleLoopOutBRLNStrikeStatus)
	r.Post("/api/apps/loopout-brln/strike/connect", s.handleLoopOutBRLNStrikeConnect)
	r.Post("/api/apps/loopout-brln/strike/disconnect", s.handleLoopOutBRLNStrikeDisconnect)
	...
	r.Get("/api/apps/loopout-brln/jobs/{id}", s.handleLoopOutBRLNJobDetail)
	...
	r.Get("/api/apps/magma-sales/backfill", s.handleMagmaBackfillPreview)
	r.Post("/api/apps/magma-sales/backfill", s.handleMagmaBackfillApply)
	r.Post("/api/apps/magma-sales/refresh", s.handleMagmaRefresh)
	r.Get("/api/apps/magma-sales/orders/{id}/open-preview", s.handleMagmaOpenPreview)
	r.Post("/api/apps/magma-sales/orders/{id}/accept", s.handleMagmaAcceptOrder)
	r.Post("/api/apps/magma-sales/orders/{id}/reject", s.handleMagmaRejectOrder)
	r.Post("/api/apps/magma-sales/orders/{id}/open", s.handleMagmaOpenChannel)
	...
	r.Post("/api/terminal/control", s.handleTerminalControl)
	...
	r.Route("/api/lnops", func(r chi.Router) {
		...
		r.Post("/channel/automation", s.handleLNChannelAutomationPost)
		...
		r.Get("/graph-explorer/storage", s.handleGraphExplorerStorageGet)
		r.Post("/graph-explorer/storage", s.handleGraphExplorerStoragePost)
		r.Post("/graph-explorer/storage/cleanup", s.handleGraphExplorerStorageCleanupPost)
	...
	r.Route("/api/rebalance", func(r chi.Router) {
		...
		r.Get("/config/snapshots", s.handleRebalanceConfigSnapshotsGet)
		r.Post("/config/snapshots", s.handleRebalanceConfigSnapshotSave)
		r.Post("/config/snapshots/{id}/restore", s.handleRebalanceConfigSnapshotRestore)
		r.Delete("/config/snapshots/{id}", s.handleRebalanceConfigSnapshotDelete)

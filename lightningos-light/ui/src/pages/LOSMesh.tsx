...
export default function LOSMesh() {
  ...
  useEffect(() => {
    if (!status) return
    const snapshot = JSON.stringify([...status.pending].sort((a,b) => a.id.localeCompare(b.id)))
  ...
  return <section className="space-y-6">
    ...
    <div className="section-card space-y-4">
      ...
      <MeshDiagnostics node={{ node: status?.radio.node || 0, name: '', short_name: '', last_heard: 0, via_mqtt: false, metrics: status?.radio.metrics }} pt={pt} />
